...
@:expose("DrawlogImage") extern class DrawlogImage implements DrawlogOutput {
	...
	function drawArrows(arrows : Array<DrawlogArrow>, isForBackground : Bool, style : DrawlogDrawStyle) : Void;
	...
	@:has_untyped function drawText(message : String, x : Float, y : Float, maxWidth : Float, isForBackground : Bool, style : DrawlogDrawStyle, textStyle : DrawlogTextStyle) : Void;
	private function endDraw(context : js.html.CanvasRenderingContext2D, style : DrawlogDrawStyle) : Void;
	...
	function removeLogger(logger : DrawlogLogger) : Bool;
	function setFileName(fileName : String) : Void;
	function setLogLevel(logLevel : Int) : Void;
	private function setStyle(context : js.html.CanvasRenderingContext2D, style : DrawlogDrawStyle) : Void;
	function startPath(x : Float, y : Float, isForBackground : Bool, style : DrawlogDrawStyle) : Void;
	function stop() : Void;
	private function stroke(context : js.html.CanvasRenderingContext2D, style : DrawlogDrawStyle) : Void;
